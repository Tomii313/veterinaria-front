                                ...
                                <div className="w-full md:w-2/3 flex flex-col gap-6">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <label className="flex flex-col gap-2">
                                            ...
                                            <input value={nombre} onChange={(e) => setNombre(e.target.value)} className="w-full rounded-xl border-slate-200 bg-white text-slate-900 focus:border-[#13ec5b] focus:ring-[#13ec5b]/20 h-12 px-4 placeholder:text-slate-300 text-sm transition-all" placeholder="Ej. Firulais" required type="text" maxLength={40} />
                                        </label>
                                        <label className="flex flex-col gap-2">
