...
function AgregarPaciente() {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault()
        try {
            const response = await fetch(`${import.meta.env.VITE_API_URL}/animales/`, {
                method: "POST",
                headers: {
            ...
            <main className="flex-1 flex flex-col items-center py-8 px-4 sm:px-6 lg:px-8 overflow-y-auto">
                <div className="w-full max-w-4xl flex flex-col gap-8">
                    ...
                    <div className="flex flex-col gap-1 text-center md:text-left">
                        <h2 className="text-3xl font-extrabold tracking-tight text-slate-900">Agregar Nueva Mascota</h2>
                        <p className="text-slate-500 text-base">Complete el formulario para registrar un nuevo paciente en el sistema.</p>
                    </div>
